...
import com.panda.print.ui.activities.WifiListActivity;
...
public class PrintUtility implements Observer {
    ...
    public PrintUtility(Activity mActivity, PrintFragment printFragment, WifiManager mWifiManager, WifiScanner mWifiScanner) {
